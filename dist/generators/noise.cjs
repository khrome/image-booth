...
exports.simplex3 = exports.simplex2 = exports.seed = exports.perlin3 = exports.perlin2 = exports.Noise = void 0;
...
function generateNoise(canvas, method) {
...
class Noise extends _generator.Generator {
  constructor(name = 'noise', engine) {
    super(name || 'noise', engine);
  }
  generate(pixels, controls) {
    const canvas = generateNoise(new _environmentSafeCanvas.Canvas({
      width: pixels.width,
      height: pixels.height
    }), methods[controls.method]);
    const newPixels = canvas.getContext('2d').getImageData(0, 0, pixels.width, pixels.height);
    return newPixels;
  }
  getControls() {
    return {
      ...
      'method': {
        'value': 'perlin2',
        'default': 'perlin2',
        'options': 'perlin2,simplex2,perlin3,simplex3'
      },
      'threshold': {
        'value': '1',
        'default': '1',
