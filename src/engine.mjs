...
import { lighten } from './compositors/lighten.mjs';
import { overlay } from './compositors/overlay.mjs';
...
export const convolve = function(pixels, filter, filter_div, offset, buffer){
    const convolveBuffer = buffer || new Canvas({ 
